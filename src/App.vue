<template>
  <div class="flex flex-col h-screen w-screen overflow-scroll gap-0.5 overflow-y-hidden">
    <!-- 头部 -->
    <div class="min-h-16 h-16 flex justify-center items-center border-b bg-base-300/50 border-base-300">
      <!-- 头部内容区 -->
      <div class="w-160 md:w-192 lg:w-256 xl:w-320 2xl:w-360 flex items-center">
        ...
        <!-- 功能按钮 -->
        <div class="flex-1 h-16 flex justify-end items-center gap-2">
          <ThemeController/>
        </div>
      </div>
    </div>
